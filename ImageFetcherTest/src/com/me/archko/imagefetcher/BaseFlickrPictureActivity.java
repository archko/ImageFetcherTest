...
import com.me.archko.imagefetcher.model.FlickrGetImagesResponse;
import com.me.archko.imagefetcher.model.FlickrImage;
import com.me.archko.imagefetcher.model.FlickrResponsePhotos;
import com.me.archko.imagefetcher.volley.GsonRequest;
...
public class BaseFlickrPictureActivity extends Activity {
    ...
    public void flickerGetImagesRequest() {
        final File f=new File(this.getFilesDir().getPath()+File.separator+Utils.FLICKR_PHOTO);
        if (f.exists()) {
        ...
        ApolloUtils.execute(false, new AsyncTask<Object, Object, FlickrResponsePhotos>() {
            ...
            protected FlickrResponsePhotos doInBackground(Object... params) {
                ...
                try {
                    ...
                    String json=Utils.parseInputStream(is);
